...
if (((MQGetGasPercentage(MQRead(MQ9PIN)/Ro,GAS_LPG)) < 8) && ((MQGetGasPercentage(MQRead(MQ9PIN)/Ro,GAS_METHANE))< 4) && ((MQGetGasPercentage(MQRead(MQ9PIN)/Ro,GAS_CARBON_MONOXIDE) )<4))
  {
  digitalWrite(BuzzerPin, LOW);    // sets the LED off
  digitalWrite(ledPin, LOW);
 ...
 else if (((MQGetGasPercentage(MQRead(MQ9PIN)/Ro,GAS_LPG)) >= 2) && ((MQGetGasPercentage(MQRead(MQ9PIN)/Ro,GAS_METHANE))>= 4) && ((MQGetGasPercentage(MQRead(MQ9PIN)/Ro,GAS_CARBON_MONOXIDE))>= 4))  
  {
    digitalWrite(BuzzerPin, HIGH);   // sets the LED on
    digitalWrite(ledPin, HIGH); 
  //lcd.clear();
...
/*
else if  ((MQGetGasPercentage(MQRead(MQ9PIN)/Ro,GAS_METHANE))>= 4)  
  {
    digitalWrite(BuzzerPin, HIGH);   // sets the LED on
    digitalWrite(ledPin, HIGH); 
  //lcd.clear();
...
else if ((MQGetGasPercentage(MQRead(MQ9PIN)/Ro,GAS_CARBON_MONOXIDE))>= 4)
{
    digitalWrite(BuzzerPin, HIGH);   // sets the LED on
    digitalWrite(ledPin, HIGH); 
  //lcd.clear();
...
*/
 ...
 /*
 if ((MQGetGasPercentage(MQRead(MQ9PIN)/Ro,GAS_CARBON_MONOXIDE)) >= 7)
  {
    digitalWrite(BuzzerPin, HIGH);   // sets the LED on
  }
  else
